...
/**
 * Performing query builder like queries on a JSON structure
 * Original author: James John, https://github.com/donjajo/php-jsondb
 */
class JSONDB {
	...
	private function _to_mysql_type($type) {
		switch ($type) {
			...
			case 'integer': $return = 'INT';
				break;
			case 'double': $return = strtoupper( $type );
				break;
